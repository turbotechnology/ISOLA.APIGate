...
`TableSplit` — вид разбиения, может принимать одно из следующих значений: 
- 0 - без разбиения, 
- 1 - разбиение по счетам, 
- 2 - разбиение по инструментам, 
- 10 - данные для УРМОКС
...
А
трибуты тэга `Row` идентичны TableSplit=0
